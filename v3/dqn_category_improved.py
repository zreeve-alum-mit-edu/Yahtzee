...
class ReplayBuffer:
    ...
    def push(self, states, actions, rewards, next_states, dones):
        ...
        Args:
            All arguments should be tensors with batch dimension
        """
...
class DQNCategoryPlayer:
    ...
    def __init__(self, Z=3, lr=1e-4, gamma=0.99, epsilon_start=1.0, epsilon_end=0.01,
                 ...
                 use_double_dqn=True, use_huber_loss=True, device='cuda'):
    ...
    def select_category_action(self, state, game, epsilon=None):
        ...
        for i in range(batch_size):
            ...
            if len(valid_indices) > 0:
                random_actions[i] = valid_indices[torch.randint(len(valid_indices), (1,))]
    ...
    def store_transitions(self, states, actions, rewards, next_states, dones):
        """Store batch of transitions in the replay buffer."""
